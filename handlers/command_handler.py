...
from config_manager import get_cached_config, update_cached_config
from utils import join_channel

def register_command_handler(client):
    """
    Registers the command handler for 'Saved Messages'.
    """
        ...
        if text.startswith('/del'):
            try:
                ...
                if 0 <= task_id < len(tasks):
                    ...
                    await update_cached_config(client, config)
